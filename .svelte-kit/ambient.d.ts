...
declare module '$env/static/private' {
	...
	export const CINNAMON_SLOWDOWN_FACTOR: string;
	...
	export const CLUTTER_PAINT: string;
	...
	export const MUFFIN_NO_SHADOWS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NVM_DIR: string;
		LOGNAME: string;
		CINNAMON_SLOWDOWN_FACTOR: string;
		_: string;
