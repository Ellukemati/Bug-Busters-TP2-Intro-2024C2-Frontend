...
/* node_modules/svelte-search/src/Search.svelte generated by Svelte v3.59.2 */
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(label_1, "style", label_1_style_value = /*hideLabel*/ ctx[3] && "position: absolute;height: 1px;width: 1px;overflow: hidden;clip: rect(1px 1px 1px 1px);clip: rect(1px, 1px, 1px, 1px);white-space: nowrap;");
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*hideLabel*/ 8 && label_1_style_value !== (label_1_style_value = /*hideLabel*/ ctx[3] && "position: absolute;height: 1px;width: 1px;overflow: hidden;clip: rect(1px 1px 1px 1px);clip: rect(1px, 1px, 1px, 1px);white-space: nowrap;")) {
...
/* src/Typeahead.svelte generated by Svelte v3.59.2 */
